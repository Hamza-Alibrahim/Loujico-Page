...
import { FaLinkedin, FaTwitter, FaFacebook, FaInstagram, FaYoutube, FaTiktok, FaWhatsapp, FaPinterest, FaSnapchat, FaTelegram } from 'react-icons/fa';
...
return (
<footer className="bg-[#0B1A2C] text-gray-300 py-10" id='follow-us'>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
        <h4 className="text-xl font-semibold mb-5 text-white">Quick Links</h4>
        ...
        <ul className="space-y-2">
            ...
            <li>
            <a href={`mailto:${FooterData.contactInfo.email}`} className="text-sm hover:text-[#B88647] transition-colors duration-300">
                {FooterData.contactInfo.email}
            </a>
            </li>
            <li>
            <a href={`tel:${FooterData.contactInfo.phone}`} className="text-sm hover:text-[#B88647] transition-colors duration-300">
    ...
    <div className="text-center text-gray-500 mt-10 pt-6 border-t border-gray-700">
        <p className="text-xs leading-relaxed">&copy; {new Date().getFullYear()} Loujico. All Rights Reserved.</p>
    </div>
    </div>
</footer>
);
