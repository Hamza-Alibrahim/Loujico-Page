...
return (
<section id={title.toLowerCase().replace(/ /g, '-')} className="py-20 bg-[#153457] text-white">
    ...
    <Slider {...settings}>
        ...
        >
            ...
            <div className="flex-grow p-4 text-[#1F476F] flex flex-col justify-center">
                ...
                <span className="font-semibold text-[#B88647] mr-2">Location:</span> 
                {project.location}
                </p>
                <p className="flex items-center text-lg">
                <span className="font-semibold text-[#B88647] mr-2">Activity:</span> 
                {project.activity}
                </p>
            </div>
            </div>
