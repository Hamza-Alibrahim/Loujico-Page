...
return (
<section id="goals" className="py-20  bg-[#1F476F] text-white"> {/* خلفية أغمق للقسم */}
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
        ...
        return (
            ...
            <div className="text-5xl md:text-6xl font-extrabold text-white mb-2"> {/* لون أبيض للأرقام */}
                <CountUp
                end={goal.target}
                duration={2.5}
                separator=","
            ...
            <h3 className="text-xl md:text-2xl font-semibold text-[#E3C194]"> {/* لون فاتح للعناوين */}
                {goal.title}
            </h3>
            </div>
        );
